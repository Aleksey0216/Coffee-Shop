...
?>
	<style type="text/css"> 					
        ...
        .sitenav ul li.current-menu-item ul.sub-menu li a:hover				
            { color:<?php echo esc_html( get_theme_mod('creamery_lite_color_scheme','#ffffff')); ?>;}
        ...
        .toggle a	
            { background-color:<?php echo esc_html( get_theme_mod('creamery_lite_color_scheme','#e03a3a')); ?>;}
		...
		textarea:focus,
		a:focus
            { outline:thin dotted <?php echo esc_html( get_theme_mod('creamery_lite_color_scheme','#e6a84c')); ?>;}
