...
function creamery_lite_setup() {		
	$GLOBALS['content_width'] = apply_filters( 'creamery_lite_content_width', 680 );	
...
define('CREAMERY_LITE_THEME_DOC',__('https://gracethemes.com/documentation/creamery-doc/#homepage-lite','creamery-lite'));
define('CREAMERY_LITE_LIVE_DEMO',__('https://gracethemes.com/demo/creamery/','creamery-lite'));
 ...
 */
add_action( 'after_setup_theme', 'creamery_lite_setup_woocommerce_support' );
function creamery_lite_setup_woocommerce_support()   
{
